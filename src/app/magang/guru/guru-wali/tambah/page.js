...
export default function TambahSiswaWaliPage() {
  ...
  // Default siswa wali = belum magang
  ...
  useEffect(() => {
    ...
    // Riwayat tempat hanya dibaca dari browser
  ...
  // =========================================================
  // AMBIL TEMPAT MAGANG HANYA KETIKA MODAL DIBUKA
  // =========================================================
  ...
  const handleStatusChange = (newStatus) => {
    ...
    // Kalau kembali menjadi BELUM MAGANG,
    // tempat magang dikosongkan.
  ...
  async function simpanSiswa() {
    ...
    try {
      ...
      const result = await addSiswa({
        ...
        // Jika belum magang, kosong.
        tempatMagang: status === "MAGANG" ? tempatMagang : "",

        // STATUS BARU
        status: status,
        // Tandai bahwa siswa ditambahkan melalui Guru Wali
        isGuruWali: true,
      });
        ...
        <div className="rounded-2xl sm:rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 shadow-sm">
          <div className="mb-6 sm:mb-8 border-b border-slate-100 pb-5">
            ...
            <p className="mt-1 text-slate-500 font-medium text-sm">
              Tambahkan siswa yang menjadi tanggung jawab Anda sebagai guru
              wali.
            </p>
          </div>
