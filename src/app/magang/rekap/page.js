                        ...
                        <table className="w-full text-sm text-left border-separate border-spacing-y-3">
                          ...
                          <tbody>
                            {item.siswa.map((s, i) => (
                              <tr
                                key={i}
                                className="bg-blue-600 text-white rounded-full transition-all duration-150 md:hover:bg-blue-700 md:hover:shadow-md"
                              >
                                ...
                                <td className="py-3.5 px-4 font-bold text-base tracking-wide whitespace-nowrap overflow-hidden text-ellipsis">
                                  <button
                                    ...
                                    className="text-left focus:outline-none hover:text-blue-200 hover:underline transition-colors flex items-center gap-2 w-full"
                                  >
                                    <svg
                                      className="w-4 h-4 text-blue-200 transition-colors flex-shrink-0"
                                      fill="none"
                                      viewBox="0 0 24 24"
                                      stroke="currentColor"
                                    >
